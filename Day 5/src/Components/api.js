...
const createProfile = async (profile) => await axios.post(`${URI}/api/v1/profile/save`,profile,{ headers})
...
export {getUser, getUserbyId, editUser, deleteUser,  adminLogin,userLogin,userRegister  , createProfile, getTasks,removeTasks , changeTasks}