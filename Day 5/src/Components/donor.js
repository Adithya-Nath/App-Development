...
function Donor() {
  ...
  const handleSubmit = () => {
    if (editIndex === -1) {
      ...
      axiosInstance
        .post('http://localhost:8080/api/v1/donor/post', formData) // Replace with your backend URL
        .then((response) => {
          // Handle the response here if needed
          console.log('Donor added:', response.data);
          handleClose();
        })
        .catch((error) => {
      ...
      axiosInstance
        .put('http://localhost:8080/api/v1/donor/put', formData) // Replace with your backend URL
        .then((response) => {
          // Handle the response here if needed
